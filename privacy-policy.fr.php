...
<ul>
  ...
  <li>
    <span class="code-highlight">has_repeller</span> : indique si l’utilisateur dispose d’un répulsif à chat grincheux, pouvant être utilisé
  </li>

  <li>
    <span class="code-highlight">review_counter_state</span>,
    <span class="code-highlight">active_game_counter_state</span>,
    <span class="code-highlight">paused_counter_state</span> : valeurs du chronomètre contenant des horodatages, des compteurs de temps écoulé et des indicateurs d’état
  </li>
  ...
  <li>
    <span class="code-highlight">next_prompt_type</span> : chaîne (peut contenir seulement 2 valeurs possibles : « reminder » et « penalty »)
  </li>

  <li>
    <span class="code-highlight">last_reward_time_at_active_counter_time_secs</span> : minuteur permettant de suivre le temps écoulé depuis la dernière récompense
  </li>
  ...
  <li>
    <span class="code-highlight">badges_serialized</span> : données concernant le plateau de jeu : badges gagnés, leurs statuts, le niveau, etc.
  </li>

  <li>
    <span class="code-highlight">autopause_config_serialized</span> : paramètres du planificateur de sommeil. ⚠️ Contient le fuseau horaire de l’utilisateur (si la fonctionnalité est utilisée).
  </li>

  <li>
    <span class="code-highlight">frontend_base_url_override</span> : URL du serveur web de la mini-application
  </li>
</ul>
