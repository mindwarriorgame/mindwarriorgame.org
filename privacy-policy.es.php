...
<ul>
  ...
  <li>
    <span class="code-highlight">diamonds</span>: cantidad actual de diamantes obtenidos
  </li>
  <li>
  ...
  <li>
    ...
    contienen marcas de tiempo, contadores de tiempo transcurrido y marcas de estado
  </li>
  ...
  <li>
    <span class="code-highlight">last_reward_time_at_active_counter_time_secs</span>: temporizador para registrar el tiempo desde que se otorgó la última recompensa
  </li>
  ...
  <li>
    <span class="code-highlight">autopause_config_serialized</span>: configuración del programador de sueño. ⚠️Contiene la zona horaria del usuario (si se usa la función).
  </li>
