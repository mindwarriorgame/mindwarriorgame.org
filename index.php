...
<body>
<div class="container">
    <a class="lang-link" href="quick-start.en.<?=getenv('LINK_EXT');?>#purpose">🇬🇧 English</a>
    <a class="lang-link" href="quick-start.de.<?=getenv('LINK_EXT');?>#purpose">🇩🇪 Deutsch</a>
    <a class="lang-link" href="quick-start.es.<?=getenv('LINK_EXT');?>#purpose">🇪🇸 Español</a>
    <a class="lang-link" href="quick-start.fr.<?=getenv('LINK_EXT');?>#purpose">🇫🇷 Français</a>
    <a class="lang-link" href="quick-start.ru.<?=getenv('LINK_EXT');?>#purpose">🇷🇺 Русский</a>
