...
?>
    ...
    <div id="smooth-forgot" class="faq-item">
        ...
        <p>
            ...
            Dependiendo del nivel de dificultad del juego, también podrías ser penalizado.
            Por favor, <a href="#difficulty">consulta la siguiente respuesta</a> para obtener detalles sobre las posibles penalizaciones.
        </p>
    ...
    <div id="smooth-difficulty" class="faq-item">
        ...
        <p>
            La frecuencia de las revisiones y las penalizaciones por revisiones perdidas están determinadas por el nivel de dificultad del juego.
        </p>
        ...
        <table>
            <tr>
                <td>Principiante</td>
                <td>
                    ⏰ revisión una vez cada 6 horas<br/>
                    😌 sin penalización por revisiones perdidas
                </td>
            </tr>
            <tr>
                <td>Fácil</td>
                <td>⏰ revisión una vez cada 3 horas<br/>
                    😌 sin penalización por la primera revisión perdida<br/>
                    😿 penalización de -3 estrellas por cada revisión perdida consecuente
                </td>
            </tr>
            <tr>
                <td>Medio</td>
                <td>⏰ revisión una vez cada 1 hora 30 minutos<br/>
                    😿 penalización de -3 estrellas por la primera revisión perdida<br/>
                    🙀 penalización de -6 estrellas por cada revisión perdida consecuente
                </td>
            </tr>
            <tr>
                <td>Difícil</td>
                <td>⏰ revisión una vez cada 1 hora<br/>
                    😿 penalización de -3 estrellas por la primera revisión perdida<br/>
                    🙀 penalización de -6 estrellas por cada revisión perdida consecuente
                </td>
            </tr>
            <tr>
                <td>Experto</td>
                <td>⏰ revisión una vez cada 45 minutos<br/>
                    🙀 penalización de -6 estrellas por revisión perdida
                </td>
            </tr>
        </table>

        <p>
            Puedes revisar tu <i>Fórmula</i> tan a menudo como desees, sin embargo, solo las revisiones realizadas al menos
            5 minutos apartadas entre sí serán recompensadas (regla de "tiempo de espera").
        </p>
    </div>
