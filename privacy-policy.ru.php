...
?>
    ...
    <p style="padding-top:0;"><sub>Последнее обновление: 2025-12-17</sub></p>


    <h3>Введение</h3>
    <p>
  Мы серьёзно относимся к вашей конфиденциальности. Ваша
  <a href="/faq.<?=$LANG;?>.<?=$ext;?>#formula">«Формула твёрдого решения»</a>
  остаётся на вашем устройстве и не отправляется на наши серверы. Игра не создаёт дополнительных копий и никуда её не загружает —
  она хранится локально в
