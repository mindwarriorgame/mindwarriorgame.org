...
<ul>
    ...
    <li>
        <span class="code-highlight">has_repeller</span>: есть ли у пользователя отпугиватель сердитого кота, доступный для использования
    </li>

    <li>
        <span class="code-highlight">review_counter_state</span>,
        <span class="code-highlight">active_game_counter_state</span>,
        <span class="code-highlight">paused_counter_state</span>: значения таймеров-секундомеров, которые
        содержат временные метки, счётчики прошедшего времени и флаги состояния
    </li>

    <li>
        <span class="code-highlight">next_prompt_time</span>, <span class="code-highlight">next_autopause_event_time</span>: временные метки
    </li>
    <li>
    ...
    <li>
        <span class="code-highlight">counters_history_serialized</span>: исторические данные счётчиков игрока для отрисовки графика прогресса
    </li>

    <li>
        <span class="code-highlight">badges_serialized</span>: данные об игровой доске: полученные значки, их статусы, уровень и т. д.
    </li>
