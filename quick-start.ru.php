...
EOF;
        ...
        renderSteps([
            ...
            "Напишите <a href='/faq.ru.{$ext}#formula' target='_blank'><i>Формулу твердой решимости</i></a>. " .
            ...
            "Если вы довольны своей \"Формулой\", нажмите кнопку \"<i>Начать игру</i>\". " .
        ...
        renderSteps([
            ...
            "После того, когда вы прочитаете Формулу, закончите просмотр нажатием кнопки \"<i>Получить награду</i>\".",
