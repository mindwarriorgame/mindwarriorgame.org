...
?>
    ...
    <div id="smooth-formula" class="faq-item">
        <h3>Что такое "Формула"? Что писать в "Формуле"?</h3>
    ...
    <div id="smooth-forgot" class="faq-item">
        ...
        <p><strong>На самом легком уровне штрафов нет! 🚫😾</strong></p>

        <p id="smooth-forgot-grumpycat" class="anchor">
            Чтобы открывать новые уровни быстрее, вы можете увеличить частоту просмотров <i>Формулы</i>,
        но награды могут выдаваться не чаще одного раза в 5 минут.
        </p>
    ...
    <div id="smooth-difficulty" class="faq-item">
        ...
        <p>
            Вы можете просматривать свою <i>Формулу</i> как угодно часто, однако <a href="#review">награды</a> 
            выдаются не чаще, чем один раз в 5 минут.
        </p>
    ...
    <div id="smooth-pause" class="faq-item">
        ...
        <p><strong>Важно!</strong> Если ваша <i>Формула</i> будет просмотрена во время вашего «интервала сна», игра возобновится.
            Это означает, что вы можете быть оштрафованы, если пропустите следующий запланированный просмотр (например, если однажды вы сделаете «поздний» просмотр в то время, когда вы обычно спите в другие дни).
            Чтобы избежать этого, вы можете вручную приостановить игру с помощью команды <span class="pre">/pause</span> после завершения «позднего» просмотра.</p>
    </div>
    ...
    <div id="smooth-controls" class="faq-item">
        ...
        <ul>
            ...
            <li><span class="pre">/shop</span> - 🛍️ магазин, в котором можно потратить награды</li>
        ...
        <ul>
            ...
            <li>
             ...
             <li>
            <i>"🌐 Сменить сервер"</i> – переключиться на другой игровой сервер, если вы столкнулись с техническими проблемами
        </li>
        </ul>
    </div>
