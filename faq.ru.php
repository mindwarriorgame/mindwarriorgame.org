        ...
        <table>
            ...
            <tr>
                ...
                <td>⏰ просмотр раз в 3 часа<br/>
                    😌 первый пропуск без штрафов<br/>
                    😿 каждый следующий пропуск: штраф 3 звезды
            </tr>
            <tr>
                <td>Средне</td>
                <td>⏰ просмотр раз в 1 час 30 минут<br/>
                    😿 первый пропуск: штраф -3 звезды<br/>
                    🙀 каждый следующий пропуск: штраф -6 звезды
                    </td>
            </tr>
            <tr>
                <td>Сложно</td>
                <td>⏰ просмотр раз в 1 час<br/>
                    😿 первый пропуск: штраф -3 звезды<br/>
                    🙀 каждый следующий пропуск: штраф -6 звезды
                    </td>
            </tr>
            <tr>
                <td>Эксперт</td>
                <td>⏰ просмотр раз в 45 минут<br/>
                        🙀 штраф -6 звезды за каждый пропуск
                    </td>
            </tr>
        </table>
