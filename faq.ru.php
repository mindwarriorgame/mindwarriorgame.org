...
?>
    ...
    <div id="smooth-forgot" class="faq-item">
        ...
        <p>
            Если вы забудете просмотреть свою <i>Формулу твердой решимости</i> вовремя, то игра напомнит вам об этом.
            В зависимости от уровня сложности игры, вы также можете быть оштрафованы за пропуск, см. таблицу из
