...
?>
    ...
    <div id="smooth-purpose" class="faq-item">
        ...
        <p>
            Цель игры "MindWarrior" – оказывать поддержку игрокам на пути их личностного развития и роста.
    ...
    <div id="smooth-formula" class="faq-item">
        ...
        <p>
            ...
            регулярно в течение дня. Вы можете писать туда
            все, что захотите. Главное, чтобы эта информация была для вас полезной и мотивирующей на вашем жизненном пути.
            Это может быть любимая цитата, мантра, личные цели, мудрые мысли и наблюдения,
        ...
        <p>
            ...
            Если же вы постоянно пропускаете просмотры, и игра напоминает вам о них, или если вы задумались бросить игру,
            возможно это признак того, что нужно улучшить свою <i>Формулу</i>.
        </p>
    ...
    <div id="smooth-review" class="faq-item">
        ...
        <p>
            Всякий раз, когда вы просматриваете свою <i>Формулу твердой решимости</i> с помощью команды 💫 <span class="pre">/review</span>, вы
            возвращаетесь к своим самым сокровенным мыслям, вытягивая себя из круговорота будничных забот, в котором так легко
            забыться и утонуть.
        </p>
    ...
    <div id="smooth-forgot" class="faq-item">
        ...
        <p>
            Если вы забудете просмотреть свою <i>Формулу твердой решимости</i> вовремя, то игра напомнит вам об этом, но вы потеряете
            игровые очки 📉. Количество зависит от уровня сложности игры.
        </p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <ul>
                        <li>первый раз: без штрафа</li>
                        <li>каждый последующий: -3 очка</li>
                    </ul>
                </td>
            </tr>
            <tr>
                <td>Средне,<br />Сложно,<br />Эксперт</td>
                <td><ul>
                        <li>первый раз: -3 очка</li>
                        <li>каждый последующий: -6 очков</li>
                    </ul></td>
            </tr>
        </table>
    </div>
    ...
    <div id="smooth-difficulty" class="faq-item">
        ...
        <p>
            ...
            чаще требуются просмотры. Сложность игры по умолчанию – "Легко" (2-й из 5-и), на этом уровне нужно просматривать
            <i>Формулу</i> не реже, чем один раз в 3 часа.
        ...
        <table>
            <tr>
                <td>Новичок</td>
                <td>просмотр один раз в 6 часов</td>
            </tr>
            <tr>
                <td>Легко</td>
                <td>раз в 3 часа</td>
        ...
        <p>
            Вы можете просматривать свою <i>Формулу</i> чаще, но <a href="#review">вознаграждаются</a> только те просмотры, между которыми
    ...
    <div id="smooth-pause" class="faq-item">
        ...
        <p>
            Когда игра "на паузе", вы не будете получать оповещения о пропущенных просмотрах <i>Формулы твердой решимости</i>, и с вас
            не будут списываться штрафные очки.
            Счетчик активного времени игры также будет приостановлен.
        </p>

        <p>
            Для возобновления игры просто просмотрите свою <i>Формулу</i> как обычно с помощью команды
