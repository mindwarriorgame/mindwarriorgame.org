...
?>
    ...
    <div id="smooth-review" class="faq-item">
        ...
        <p>
            С точки зрения игры, просмотры <i>Формулы</i> приносят вам награды!
        </p>
    ...
    <div id="smooth-forgot" class="faq-item">
        ...
        <p>
            Если вы забудете просмотреть свою <i>Формулу твердой решимости</i> вовремя, то игра напомнит вам об этом, но вы будете оштрафованы.
            Размер штрафа зависит от уровня сложности игры. См. таблицу из <a href="#difficulty">следующего ответа</a> для подробностей.
        </p>
    ...
    <div id="smooth-difficulty" class="faq-item">
        ...
        <table>
            <tr>
                <td>Новичок</td>
                <td><ul>
                        <li>просмотр один раз в 6 часов</li>
                        <li>без штрафов</li>
                    </ul>
                </td>
            </tr>
            <tr>
                <td>Легко</td>
                <td><ul><li>просмотр раз в 3 часа</li>
                        <li>первый пропуск без штрафов</li>
                        <li>каждый следующий пропуск: штраф 3 звезды</li>
            </tr>
            <tr>
                <td>Средне</td>
                <td><ul><li>просмотр раз в 1 час 30 минут</li>
                        <li>первый пропуск: штраф 3 звезды</li>
                        <li>каждый следующий пропуск: штраф 6 звезды</li>
                    </ul></td>
            </tr>
            <tr>
                <td>Сложно</td>
                <td><ul><li>просмотр раз в 1 час</li>
                        <li>первый пропуск: штраф 3 звезды</li>
                        <li>каждый следующий пропуск: штраф 6 звезды</li>
                    </ul></td>
            </tr>
            <tr>
                <td>Эксперт</td>
                <td><ul><li>просмотр раз в 45 минут</li>
                        <li>штраф 6 звезды за каждый пропуск</li>
                    </ul></td>
            </tr>
        </table>
