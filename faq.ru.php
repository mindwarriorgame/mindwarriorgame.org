...
?>
    ...
    <div id="smooth-forgot" class="faq-item">
        ...
        <p>
            За первый пропущенный просмотр вы потеряете 3 очка, а за каждый последующий – 6. Так будет продолжаться
            до тех пор, пока вы не просмотрите свою <i>Формулу</i>.
        </p>
    </div>
    ...
    <div id="smooth-difficulty" class="faq-item">
        ...
        <p>
            ...
            <i>Формулу</i> не реже, чем один раз в 1 час 30 минут.
