...
<div id="smooth-forgot" class="faq-item">
    ...
    <p>
        ...
        but you will lose be penalised 🟥 according to the difficulty level of the game.
        Please <a href="#difficulty">refer to the next answer</a> for the details.
    </p>
...
<div id="smooth-difficulty" class="faq-item">
    ...
    <p>
        The frequency of reviews and the penalties for missed reviews are determined by the difficulty level of the game.
    </p>
    ...
    <table>
        <tr>
            ...
            <td>
                <ul>
                    <li>review once per 6 hours</li>
                    <li>no penalty for missed reviews</li>
                </ul>
            </td>
        </tr>
        <tr>
            <td>Easy</td>
            <td><ul>
                    <li>review once per 3 hours</li>
                    <li>no penalty for the fist missed review</li>
                    <li>3 stars penalty for each consequent missed review</li>
                </ul>
            </td>
        </tr>
        <tr>
            <td>Normal</td>
            <td><ul>
                    <li>review once per 1 hour 30 minutes</li>
                    <li>3 stars penalty for the first missed review</li>
                    <li>6 stars penalty for each consequent missed review</li>
                </ul>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Expert</td>
            <td><ul>
                    <li>review once per 45 minutes</li>
                    <li>6 stars penalty for missed review</li>
                </ul>
            </td>
        </tr>
    </table>
