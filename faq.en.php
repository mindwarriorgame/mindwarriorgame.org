...
<div id="smooth-forgot" class="faq-item">
    ...
    <p>
        ...
        but you will lose gaming scores 📉. The amount of points you lose depends on the difficulty level of the game.
    </p>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <ul>
                    <li>first time: no penalty</li>
                    <li>each consequent miss: -3 points</li>
                </ul>
            </td>
        </tr>
        <tr>
...
<div id="smooth-difficulty" class="faq-item">
    ...
    <table>
        <tr>
            <td>Beginner</td>
            <td>once per 6 hours</td>
        </tr>
        <tr>
            <td>Easy</td>
            <td>once per 3 hours</td>
        </tr>
        <tr>
            <td>Normal</td>
...
<div id="smooth-pause" class="faq-item">
    ...
    <p>
        To resume the game, simply review your <i>Formula</i> as usually with
