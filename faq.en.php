...
<div id="smooth-forgot" class="faq-item">
    ...
    <p>
        ...
        Depending on the difficulty level of the game, you also might be penalised.
        Please <a href="#difficulty">refer to the next answer</a> for the details about possible penalties.
    </p>
    ...
    <table>
        <tr>
            ...
            <td>
                    ...
                    😌 no penalty for missed reviews
            </td>
        </tr>
        <tr>
            <td>Easy</td>
            <td>⏰ review once per 3 hours<br/>
                    😌 no penalty for the fist missed review<br/>
                    😿 -3 stars penalty for each consequent missed review
            </td>
        </tr>
        <tr>
            <td>Normal</td>
            <td>⏰ review once per 1 hour 30 minutes<br/>
                    😿 -3 stars penalty for the first missed review<br/>
                    🙀 -6 stars penalty for each consequent missed review
            </td>
        </tr>
        <tr>
            <td>Hard</td>
            <td>⏰ review once per 1 hour<br/>
                    😿 -3 stars penalty for the first missed review<br/>
                    🙀 -6 stars penalty for each consequent missed review
            </td>
        </tr>
        <tr>
            <td>Expert</td>
            <td>⏰ review once per 45 minutes<br/>
                    🙀 -6 stars penalty for missed review
            </td>
        </tr>
    </table>
