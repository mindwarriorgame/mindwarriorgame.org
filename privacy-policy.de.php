...
<ul>
  ...
  <li>
    <span class="code-highlight">has_repeller</span>: ob der Nutzer einen Grumpy-Cat-Repeller hat, der verwendet werden kann
  </li>

  <li>
    <span class="code-highlight">review_counter_state</span>,
    <span class="code-highlight">active_game_counter_state</span>,
    <span class="code-highlight">paused_counter_state</span>: Stoppuhr-Zustandswerte, die Zeitstempel, verstrichene Zeit-Zähler und Status-Flags enthalten
  </li>
  ...
  <li>
    <span class="code-highlight">last_reward_time_at_active_counter_time_secs</span>: ein Timer, um die Zeit seit der letzten Belohnung zu verfolgen
  </li>

  <li>
    <span class="code-highlight">counters_history_serialized</span>: Verlaufsdaten der Zähler des Spielers zum Rendern des Fortschrittsdiagramms
  </li>
  ...
  <li>
    <span class="code-highlight">autopause_config_serialized</span>: Einstellungen des Schlafzeitplaners. ⚠️Enthält die Zeitzone des Nutzers (falls die Funktion verwendet wird).
  </li>
